...
const lostFoundSchema = new mongoose_1.Schema({
    ...
    matches: [
        {
            reportId: { type: mongoose_1.Schema.Types.ObjectId, ref: "LostFound" },
...
const LostFound = mongoose_1.default.model("LostFound", lostFoundSchema);
exports.default = LostFound;
